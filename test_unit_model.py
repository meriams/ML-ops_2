...
img = cv2.imread(r'C:\Users\test\Documents\Github\repos\ML_ops_Team\ML-ops\dataset\train\angry\Training_3908.jpg')
...
#def test_input_image_shape():
img = cv2.imread(r'C:\Users\test\Documents\Github\repos\ML_ops_Team\ML-ops\dataset\test\angry\PrivateTest_1109992.jpg')
...
train_data = datasets.ImageFolder(cfg.trainDirectory, transform=train_transformer)
...
classes_rules = [class_labels_list == true_labels_list,
                number_of_classes == 7]

test_classes(classes_rules)
